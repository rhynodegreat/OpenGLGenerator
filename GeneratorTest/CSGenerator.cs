...
namespace GeneratorTest {
    public class CSGenerator {
        ...
        void GenerateWrapper(StreamWriter writer, string api, int major, int minor, string profile) {
            ...
            writer.WriteLine();
            writer.WriteLine("namespace OpenGL {");
            writer.WriteLine("    public static partial class {0}{1}_{2}_{3} {{", api.ToUpper(), major, minor, profile);
            ...
            for (int i = 0; i < commands.Count; i++) {
                ...
                for (int j = 0; j < c.Parameters.Count; j++) {
                    ...
                    if (p.Pointer && p.Type != "GLchar*") pointers = true;
                    if (p.Type == "void*") {
                        _unsafe = true;
                        break;
                    }
                ...
                for (int j = 0; j < c.Parameters.Count; j++) {
                    ...
                    if (pType[pType.Length - 1] == '*' && pType != "void*") {
                ...
                if (pointers) {
                    GeneratePointerWrapper(writer, c);
                } else {
        ...
        void GenerateSimpleWrapper(StreamWriter writer, Command c) {
            writer.Write("            ");
